...
public class ProtobufWriter<Value extends Message> implements Writer<Value> {
  ...
  public static <Value extends Message> ProtobufWriter<Value> fromDescriptor(
    ...
    return fromDescriptor(descriptor, protobufParquetConfig, SchemaTraversalSpecs.all());
  }

  public static <Value extends Message> ProtobufWriter<Value> fromDescriptor(
      final Descriptors.Descriptor descriptor,
      final ProtobufParquetConfig protobufParquetConfig,
      final SchemaTraversalSpec schemaTraversalSpec) {
    return new ProtobufWriter<>(
        descriptor,
        new ProtobufSchemaConverter(protobufParquetConfig)
            .convertDescriptorToSchema(descriptor, schemaTraversalSpec));
  }
